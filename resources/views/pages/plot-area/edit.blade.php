    ...
    <div class="main-panel">
        <div class="content-wrapper p-sm-5 p-2 pt-4">
            <div class="container-fluid periode-section mb-4">
                ...
                <form method="POST" action="{{ route('plot-area.update', $plot->id) }}">
                    @csrf
                    @method('PUT')
                    <fieldset>
                        ...
                        <div class="row mt-3">
                            <div class="form-group mb-3 col-6">
                                ...
                                <input id="latitude" class="form-control" name="latitude" id="latitude" type="text" value="{{ $plot->latitude }}"
                                    required readonly>
                            </div>
                            <div class="form-group mb-3 col-6">
                                <label for="longitude">Longitude</label>
                                <input id="longitude" class="form-control" name="longitude" id="longitude" type="text" value="{{ $plot->longitude }}"
                                    required readonly>
                            </div>
                            <div class="form-group mb-3 col-6">
                                <label for="nama_plot">Nama Plot</label>
                                <input id="nama_plot" class="form-control" name="nama_plot" type="text" required value="{{ $plot->nama_plot }}">
                            </div>
