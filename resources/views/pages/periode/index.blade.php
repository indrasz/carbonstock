            ...
            <div class="data-table-area">
                <div class="container-fluid periode-section mb-4">
                    <div class="d-block d-sm-flex justify-content-between align-items-center text-center text-sm-start mb-4">
                        ...
                        <a href="{{ route('periode.create') }}" class="btn btn-success rounded-3 mt-3 mt-sm-0">Tambahkan
                            Data</a>
                    </div>
                    ...
                    <div class="row">
                        @foreach ($periode as $index => $item)
                            <div class="col-12 box-margin">
                                <div class="card mb-2">
                                    <div class="card-body">
                                        <h4 class="card-title mb-2">Periode ke-{{ $index + 1 }}</h4>
                                        <div class="row align-items-center">
                                            <div class="col-sm-4 col-12">
                                                <div class="d-flex justify-content-between gap-4 align-items-center mb-2">
                                                    ...
                                                    <p class="m-0" style="color: #90A8BF">{{ $item->tgl_mulai }}</p>
                                                </div>
                                                <div class="d-flex justify-content-between gap-4 align-items-center">
                                                    ...
                                                    <p class="m-0" style="color: #90A8BF">{{ $item->tgl_berakhir }}</p>
                                                </div>
                                            </div>
                                            <div class="col-sm-8 col-12">
                                                <div class="text-sm-end text-start gap-2 d-flex d-sm-block mt-sm-0 mt-2">
                                                    <a href="{{ route('periode.edit', 1) }}"
                                                        class="btn btn-warning rounded-3 p-2">Ubah Data</a>
